...
export default function EditVoucherPage({ params }: { params: { id: string } }) {
  ...
  const fetchVoucher = async () => {
    try {
      ...
      // Convert amounts from pence to pounds for form display
      setFormData({
        code: data.voucher.code,
        type: data.voucher.type,
        value: data.voucher.value,
        minimumOrderAmount: (data.voucher.minimumOrderAmount || 0) / 100,
        maximumDiscount: (data.voucher.maximumDiscount || 0) / 100,
        ...
        categoryIds: data.voucher.categoryIds || [],
      });
    } catch (err: any) {
      ...
      <div className="min-h-screen bg-gray-100">
        <div className="max-w-4xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
          <div className="bg-red-50 border border-red-200 rounded-md p-4">
            <p className="text-sm text-red-700">Voucher not found</p>
          </div>
        </div>
      </div>
    );
      ...
      <div className="max-w-4xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white shadow rounded-lg">
          <div className="px-6 py-4 border-b border-gray-200">
            <h1 className="text-2xl font-bold text-gray-900">Edit Voucher: {voucher.code}</h1>
          </div>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    required
                  />
                  <p className="text-xs text-gray-500 mt-1">Current usage: {voucher.usedCount}</p>
                </div>
