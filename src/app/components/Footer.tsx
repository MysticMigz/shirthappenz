        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link href="/printing/dtg" className="text-gray-300 hover:text-purple-400 transition-colors">
                  DTG Printing
                </Link>
              </li>
              <li>
                <Link href="/printing/screen" className="text-gray-300 hover:text-purple-400 transition-colors">
                  Screen Printing
                </Link>
              </li>
              <li>
                <Link href="/printing/embroidery" className="text-gray-300 hover:text-purple-400 transition-colors">
                  Embroidery Services
                </Link>
              </li>
              <li>
            ...
            <div className="space-y-3">
              <div className="flex">
                <input
                  ...
                  className="flex-1 px-3 py-2 bg-gray-800 border border-gray-600 rounded-l-lg text-white text-sm focus:outline-none focus:border-purple-500"
                />
                <button className="bg-gradient-to-r from-purple-600 to-blue-600 px-4 py-2 rounded-r-lg text-white text-sm hover:shadow-lg transition-all">
                  Subscribe
                </button>
              </div>
